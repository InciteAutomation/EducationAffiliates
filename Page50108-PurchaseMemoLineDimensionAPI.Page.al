page 50108 "Purch Mem Dim Set Lines"
{
    APIVersion = 'v2.0';
    EntityCaption = 'Purchase Credit Memo Dimension Set Line';
    EntitySetCaption = 'Purchase Credit Memo Dimension Set Lines';
    DelayedInsert = true;
    EntityName = 'purchaseCreditMemoDimensionSetLine';
    EntitySetName = 'purchaseCreditMemoDimensionSetLines';
    APIPublisher = 'InciteAutomation';
    APIGroup = 'purchaseCreditMemoDimensions';
    PageType = API;
    ...
    begin
        ...
        Rec."Parent Type" := Rec."Parent Type"::"Purchase Credit Memo Line";
