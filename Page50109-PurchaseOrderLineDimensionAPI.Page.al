page 50109 "Purch Ord Dim Set Lines"
{
    APIVersion = 'v2.0';
    EntityCaption = 'Purchase Order Dimension Set Line';
    EntitySetCaption = 'Purchase Order Dimension Set Lines';
    DelayedInsert = true;
    EntityName = 'purchaseOrderDimensionSetLine';
    EntitySetName = 'purchaseOrderDimensionSetLines';
    APIPublisher = 'InciteAutomation';
    APIGroup = 'purchaseOrderDimensions';
    PageType = API;
    ...
    begin
        ...
        Rec."Parent Type" := Rec."Parent Type"::"Purchase Order Line";
